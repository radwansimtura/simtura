...
export async function registerRoutes(
  ...
  const PUBLISHED_EMS_TITLES = ["Sports Injury - Primary Assessment", "Respiratory Failure - Elderly Patient", "Severe Hemorrhage - Thigh Laceration", "Combative Overdose - Suspected Opioid Reversal", "Pediatric Asthma Attack - Acute Exacerbation", "Multi-Patient MVC - Driver #1 (Post-Triage)"];
