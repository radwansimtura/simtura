  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight" data-testid="text-scenarios-title">Training Scenarios</h1>
          <p className="mt-2 text-muted-foreground">
            Choose a scenario to begin your training session. Each scenario simulates a real patient encounter.
          </p>
        </div>
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {["All", "EMR", "EMT", "AEMT", "Paramedic"].map((cert) => (
              <Button
                key={cert}
