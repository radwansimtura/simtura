...
// Hidden from the discipline list; still reachable by direct URL.
const HIDDEN_SCENARIO_IDS = new Set<string>([
  "9a500337-e965-4443-822a-213b73d3f82f", // STEMI (still has unverified video issues; hidden pending Yousef's review)
]);
